...
gulp.task('watch', function () {
  ...
  browserSync.init({
    ...
    proxy: 'localhost:8888/' + projectFolder + '/public',
    notify: false
  ...
  gulp.watch(['public/*/*.html', 'public/*/*.php', 'public/assets/css/*.css', 'public/assets/js/*.js', 'public/assets/js/vendors/*.js']).on('change', browserSync.reload);
